...
INSERT INTO `__new_addons`("id", "name", "description", "price", "is_active") SELECT "id", "name", "description", "price", "is_active" FROM `addons`;--> statement-breakpoint
...
CREATE TABLE `__new_bookings` (
	...
	`created_at` text DEFAULT '2025-07-21T06:56:35.222Z',
...
--> statement-breakpoint
INSERT INTO `__new_classes`("id", "title", "description", "instructions", "location", "thumbnail", "gallery", "max_spots", "booked_spots", "is_active", "trainer_id", "class_pack_ids", "class_schedule_ids", "created_at") SELECT "id", "title", "description", "instructions", "location", "thumbnail", "gallery", "max_spots", "booked_spots", "is_active", "trainer_id", "class_pack_ids", "class_schedule_ids", "created_at" FROM `classes`;--> statement-breakpoint
...
CREATE TABLE `__new_enquiries` (
	...
	`created_at` text DEFAULT '2025-07-21T06:56:35.223Z'
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`created_at` text DEFAULT '2025-07-21T06:56:35.220Z'
);
--> statement-breakpoint
